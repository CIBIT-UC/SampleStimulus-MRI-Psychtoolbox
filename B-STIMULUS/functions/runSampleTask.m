...
%   : runName - string with the name of the run. Must match the protocol
%   .mat file generated before and located in S.input_path.
%
% Outputs:
...
try
    ...
    for ii = 1:nFrames % Iteration on the frames
        ...
        switch framesCond(ii)
            ...
            case reportIdx % Keypress Report
                ...
                if S.RSPBOX
                    ...
                    if keyPress
                        a = find(keyCode==1);
                        if length(a) == 1; keysPressed(ii,1) = a; end
                    end
                end
                  
            case movingIdx % Dots Moving
                
                [dots, changeDir] = drawMovingDots(windowID, S, dots, changeDir);
            ...
            otherwise % Fixation and Discard
                
                drawFixationCross( windowID , S , 'purple' )
                changeDir = true;      
                
        end % End switch on the condition
